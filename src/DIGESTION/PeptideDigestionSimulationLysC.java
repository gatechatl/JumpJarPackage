...
public class PeptideDigestionSimulationLysC {

	public static String parameter_info() {
		return "[inputFile] [upperLimitFragmentSize] [outputFile]";
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			int upperLimit = new Integer(args[1]);
			...
			while (itr.hasNext()) {
				...
				HashMap map = simulateDegrade(seq, upperLimit);
	...
	public static HashMap simulateDegrade(String seq, int upperLimit) {
